                ...
                <ul>
                  <li>
                    <a href={props.data ? props.data.facebook : "/"}>
                      <i className="fab fa-facebook-f"></i> {/* Cambiado a fab fa-facebook-f */}
                    </a>
                  </li>
                  <li>
                    <a href={props.data ? props.data.twitter : "/"}>
                      <i className="fab fa-twitter"></i> {/* Cambiado a fab fa-twitter */}
                    </a>
                  </li>
                  <li>
                    <a href={props.data ? props.data.youtube : "/"}>
                      <i className="fab fa-youtube"></i> {/* Cambiado a fab fa-youtube */}
                    </a>
                  </li>
                </ul>
              </div>
